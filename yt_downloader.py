...
@@ -152,13 +168,18 @@ def create_widgets(self):
...
"""浏览并选择保存路径"""
@@ -174,6 +195,61 @@ def validate_url(self, url):
except ValueError:
return False
...
"""查询视频格式"""
url = self.url_entry.get().strip()
@@ -185,15 +261,6 @@ def query_formats(self):
...
"""更新进度条和进度信息"""
@@ -398,98 +395,357 @@ def process_queue(self):
"""处理下载队列"""
while True:
try:
